package net.vk.onlineshopping.controller;
...
import net.vk.onlineshopping.exception.ProductNotFoundException;
...
public class PageController {
	...
	public ModelAndView showCategoryProducts(@PathVariable("id") int id) {
		...
		// passing the the single category list
	...
	/*
	 * viewing a signle product detail
	 */
	...
	// having similar mapping to our flow
