...
import net.vk.onlineshopping.util.FileUploadUtility;
import net.vk.onlineshopping.validator.ProductValidator;
...
public class ManagementController {
	...
	public String handleProductActivation(@PathVariable int id) {
		...
		// activation and deactivation based on the current status
