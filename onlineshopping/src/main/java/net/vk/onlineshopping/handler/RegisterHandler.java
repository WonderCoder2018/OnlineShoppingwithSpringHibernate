package net.vk.onlineshopping.handler;
...
import net.vk.onlineshopping.model.RegisterModel;
...
public class RegisterHandler {
	...
	public void addUser(RegisterModel registeModel, User user) {

		registeModel.setUser(user);
