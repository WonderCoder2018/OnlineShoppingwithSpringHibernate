	...
	<div class="row">
		...
		<div class="offset-2 col-md-8">
			<div class="panel panel-primary border">
				<div class="panel-heading border" style="background-color: #698EE4">
					<h4>Product Management</h4>
				</div>
				<div class="panel-body">

					<!-- FORM ELEMENTS -->
					<sf:form class="form-horizontal border" modelAttribute="product"
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<button type="type" class="close" data-dismiss="modal">
						<span>&times;</span>
					</button>
					...
					<sf:form id="categoryForm" modelAttribute="category"
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								...
								<sf:input typ="text" path="name" id="category_name"
									class="form-control" />
							</div>
						</div>
						<div class="form-group row">
