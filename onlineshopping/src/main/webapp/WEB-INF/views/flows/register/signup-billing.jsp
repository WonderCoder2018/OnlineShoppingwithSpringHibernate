			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<sf:form method="POST" class="form-horizontal" id="billingForm"
						...
						<div class="form-group row">
							<label class="control-label col-md-4" for="cit">City</label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<div class="offset-4 col-md-8">
								<button type="submit" class="btn btn-primary"
									name="_eventId_personal"><span class="glyphicon glyphicon-chevron-left"></span>Previous
								</button>
								<button type="submit" class="btn btn-primary"
									name="_eventId_confirm">Next<span class="glyphicon glyphicon-chevron-right"></span>
								</button>
							</div>
						</div>
					</sf:form>
